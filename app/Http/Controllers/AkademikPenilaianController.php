...
class AkademikPenilaianController extends Controller
{
  /**
  ...
  */
  ...
  public function index() {
    ...
    return view('akademik.penilaian.index', compact('data', 'idta'));
  }
  ...
  public function detail($idkelas,$idmapel,$idjenis)
  {
    ...
    return view('akademik.penilaian.detail', compact('ta','kelas','mapel','guru','siswa', 'jadwal', 'penugasan'));
  }
  ...
  public function detailquiz($idkelas,$idmapel,$idjenis)
  {
   ...
   return view('akademik.penilaian.detailquiz', compact('ta','kelas','mapel','guru','siswa', 'jadwal', 'evaluasi', 'materi', 'bulan'));
  }

  public function detailevaluasi($id)
  {
    return view('akademik.penilaian.detailevaluasi');
  }
  ...
  public function cetaknilaitugas(Request $request)
  {
    ...
    if ($kelas->idkurikulum == 1) {
      ...
      $pdf = PDF::loadView('akademik.penilaian.nilaitugas', compact('ta','mapel','kelas','jadwal','guru','siswa','nilaimapel','grade','namakelas','agama', 'penugasan'))->setPaper('A4','landscape');
  ...
  public function cetakevaluasi($idkelas,$idmapel)
  {
    ...
    $pdf = PDF::loadView('akademik.penilaian.cetakevaluasi', compact('ta','kelas','mapel','guru','siswa', 'jadwal', 'evaluasi', 'materi', 'bulan'))->setPaper('A4','landscape');
