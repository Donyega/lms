                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tr>
                          <td>NUPTK</td>
                          <th>{{$data->nuptk == null ? '-' : $data->nuptk}}</th>
                        </tr>
                        <tr>
                          <td>NIP</td>
                        ...
                        <tr>
                          ...
                          <td><b>{{$data->detil->skpengangkatan}}</b></td>
                        </tr>
                        <tr>
                          <td>TMT Pengangkatan</td>
                          <td><b>{{(new \App\Helper)->tanggal($data->detil->tmtpengangkatan)}}</b></td>
                        </tr>
                        <tr>
                          <td>Masa Kerja</td>
                          <td><b>{{(new \App\Helper)->lamamengajar($data->detil->tmtpengangkatan)}}</b></td>
                        </tr>
                        <tr>
                          <td>Pangkat / Golongan</td>
                          <td><b>{{$data->detil->idpangkat == null ? '' : $data->detil->pangkat->pangkat.' ('.$data->detil->pangkat->golongan.'/'.$data->detil->pangkat->ruang.')'}}</b></td>
                        </tr>
                      </table>
                      <hr class="m-0">
                    </div>
                              ...
                              <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                                ...
                                <div class="mt-sm-0 mt-50">
                                  @if($rp->dokijazah != null)
                                    <a href="{{asset($rp->dokijazah)}}" class="btn btn-sm btn-outline-{{$backi}}" target="_blank"><i data-feather="file-text"></i> Dokumen Ijazah</a>
                                  @endif
                                  @if($rp->doktranskrip != null)
                                    <a href="{{asset($rp->doktranskrip)}}" class="btn btn-sm btn-outline-{{$backt}}" target="_blank"><i data-feather="file-text"></i> Dokumen Transkrip Nilai</a>
                                  @endif
                                </div>
                              </div>
                            </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="forms-sample" action="{{route('md.pegawai.update')}}" method="post" enctype="multipart/form-data" id="formguru">
...
<div class="modal fade" id="modal-kepegawaian" tabindex="false" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="forms-sample" action="{{route('md.pegawai.updatekepegawaian')}}" method="post" enctype="multipart/form-data" id="formguru">
          <input type="hidden" name="idpegawai" value="{{$data->id}}">
          <div class="row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="col-sm-12">
                <input type="text" name="nuptk" class="form-control" value="{{$data->nuptk}}" autocomplete="off">
              </div>
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <div class="col-sm-12">
                <input type="text" name="nip" class="form-control" value="{{$data->nip}}" autocomplete="off">
              </div>
            </div>

            <div class="form-group col-md-6">
              <label class="col-sm-12 col-form-label"><b>Nomor SK Pengangkatan</b></label>
              <div class="col-sm-12">
                <input type="text" class="form-control" name="skpengangkatan" value="{{$data->detil->skpengangkatan}}" autocomplete="off">
              </div>
            </div>

            <div class="form-group col-md-6">
              <label class="col-sm-12 col-form-label"><b>TMT Pengangkatan</b></label>
              <div class="col-sm-12">
                <input type="text" name="tmtpengangkatan" value="{{$data->detil->tmtpengangkatan}}" class="form-control flatpickr-basic"  placeholder="Pilih" style="background-color: white">
              </div>
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <div class="col-sm-12">
                <select class="form-control show-tick ms select2" id="idpangkat" name="idpangkat">
