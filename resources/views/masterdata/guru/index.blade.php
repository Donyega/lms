    ...
    <div class="row match-height">
      <div class="col-12 mb-75">
        <div class="text-center text-lg-left">
          <button class="btn btn-danger mb-25" type="button"  data-toggle="modal" data-target="#modal-guru" data-backdrop="static" data-keyboard="false" id="btnsiswa"><i data-feather="plus"></i> Tambah Guru</button>
          <form class="d-inline" action="{{route('md.pegawai.generateuser')}}" method="post" onsubmit="return confirm('Lanjutkan proses pembuatan user baru untuk semua guru aktif yang belum memiliki user?')">
            <input type="hidden" name="role" value="2">
            <input type="hidden" name="jenispegawai" value="1">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <table class="table table-bordered table-hover" id="tabelguru">
        ...
        <form id="jquery-val-form" class="forms-sample" action="{{route('md.pegawai.store')}}" method="post" enctype="multipart/form-data" id="formguru">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              <label class="col-sm-12 col-form-label"><b>Nama Guru</b></label>
              <div class="col-sm-12">
...
<div class="modal fade" id="modal-export" tabindex="false" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaltitle">Export Data Guru</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="forms-sample" action="{{route('md.pegawai.exportexcel')}}" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              <label class="col-sm-12 col-form-label"><b>Pilih Status Guru</b></label>
              <div class="col-sm-12">
...
$(document).ready(function() {
  ...
  $('#idstatus2').on('change', function(){
    ...
    table.ajax.url('/masterdata/guru/dt/'+idstatusguru).load();
  })

  $('#tabelguru tbody').on('click', '#btnuser', function () {
